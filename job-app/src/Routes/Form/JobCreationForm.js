    ...
    return (
      <div className="post-job-container">
        <form onSubmit={handleSubmit} className="post-job-Form">
          ...
          <input className="job-input job-title-input" value={jobTitle} type="text" onChange={getTitle} />

          <label className="job-title" for="Company Name">
            Company Name
          </label>
          <input className="job-input company-name-input" type="text" value={company} onChange={getCompany} />

          <label className="job-title" for="Job Location">
            Location
          </label>
          <input className="job-input job-location-input" type="text" onChange={getLocation} />

          <label className="job-title" for="Job Type">
            What type of employement is it?
          </label>
          <select className="job-input-select" name="category" id="employment" onChange={getEmployType} >
          ...
          <input className="job-input job-salary-input" type="number" onChange={getSalary} />

          <label className="job-title" for="Submission deadline">
            Submission deadline
          </label>
          <input className="job-input job-deadline-input" type="date" onChange={getDate} />

          <label className="job-title" for="Job Category">
            What Sector is this job categorized under?
          </label>
          <select className="job-input-select" name="category" id="employment" onChange={getCategory} >
            <option value="Empty">Select option</option>
          ...
          <textarea className="phoneNumber textarea" type="text" style={{ width: "100%", height: "30%" }} onChange={getDesc} />
          <input
